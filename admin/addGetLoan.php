...
$sql = mysqli_query($con, "SELECT * from `getloanpage`");
...
if(isset($_POST['saveAgent']))
{
    ...
    $sql = "UPDATE getloanpage set details = '$details' where `id` = 1 ";
    if ( mysqli_query($con,$sql) )
    {
        $msg =  'success';
        $successMsg = "Get a Loan Page Successfully Updated";
    } 
    else
        $msg = 'error';
}
...
<head>
    <meta charset="UTF-8">
    <title>Get Loan Page Update</title>
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating Get a Loan page </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="howItworks">Get a Loan Text</label>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update Get a Loan</button>
                                </div>
                            </form>

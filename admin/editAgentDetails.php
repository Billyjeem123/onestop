...
if(isset($_POST['saveAgent']))
{
    ...
    $sql = "UPDATE `agent` set `fullName` = '$name',`referralCode`= '$referralCode' where `id` = '$id' ";
    if ( mysqli_query($con,$sql) )
    {
        $msg =  'success';
        $successMsg = "Agent Details Successfully Updated";
    } 
    else
        $msg = 'error';
}
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating Agent Details </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="agentName" name="agentName" value="<?php echo ucfirst($res['fullName']); ?>" class="form-control" required="" >
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="referralCode" name="referralCode" value="<?php echo $res['referralCode']; ?>" class="form-control" required="" >
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update Agent Details </button>
                                </div>
                            </form>

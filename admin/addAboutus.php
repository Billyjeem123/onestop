...
$sql = mysqli_query($con, "SELECT * from `aboutuspage`");
...
if(isset($_POST['saveAgent']))
{
    ...
    $sql = "UPDATE aboutuspage set details = '$details' where `id` = 1 ";
    if ( mysqli_query($con,$sql) )
    {
        $msg =  'success';
        $successMsg = "About Us Page Successfully Updated";
    } 
    else
        $msg = 'error';
}
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating About Us page </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="howItworks">About Us Text</label>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update About Us</button>
                                </div>
                            </form>

...
$sql = mysqli_query($conn, "SELECT * from `termspage`");
...
if(isset($_POST['saveAgent']))
{
    ...
    $sql = "UPDATE termspage set details = '$details' where `id` = 1 ";
    if ( mysqli_query($con,$sql) )
    {
        $msg =  'success';
        $successMsg = "Terms and Condition Page Successfully Updated";
    } 
    else
        $msg = 'error';
}
...
<head>
    <meta charset="UTF-8">
    <title>General Terms Page Update</title>
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating Terms and Condition page </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="howItworks">Terms and Condition Text</label>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update Terms and Condition</button>
                                </div>
                            </form>

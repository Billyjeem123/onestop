...
$successMsg = "";
$errorMsg = "";
//get the howitworks page for update
$sql = mysqli_query($conn, "SELECT * from `homepage`");
...
if(isset($_POST['saveAgent']))
{
    ...
    $details = mysqli_real_escape_string($conn, $_POST['howItworks']);
    $sql = "UPDATE homepage set header = '$header', details = '$details' where `id` = 1 ";
    if ( mysqli_query($conn,$sql) )
    {
        $msg =  'success';
        $successMsg = "Home Page Successfully Updated";
    } 
    else
        $msg = 'error';
}
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating Hoem Page </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="header">Home Page Header Text</label>
                                            <textarea name="header" id="header" required="" class="form-control">
                                                <?php echo $header; ?>
                                            </textarea>   
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="howItworks">Home Page Text</label>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update Home page</button>
                                </div>
                            </form>

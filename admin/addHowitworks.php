...
$sql = mysqli_query($con, "SELECT * from `howitworkspage`");
...
if(isset($_POST['saveAgent']))
{
    ...
    $sql = "UPDATE howitworkspage set header = '$header', details = '$details' where `id` = 1 ";
    if ( mysqli_query($con,$sql) )
    {
        $msg =  'success';
        $successMsg = "How It Works Page Successfully Updated";
    } 
    else
        $msg = 'error';
}
...
<head>
    <meta charset="UTF-8">
    <title>How It Works Page Update</title>
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" name="register" id="register" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        { ?>
                                            ...
                                            if (isset($msg) and $msg == 'error') { ?>
                                                ...
                                                <strong>Error Updating how it works page </strong>
                                                </div>
                                            <?php  } ?>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-8">
                                            ...
                                            <textarea name="header" id="header" required="" rows="3" class="form-control">
                                                <?php echo $header; ?>
                                            </textarea>   
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label for="howItworks">How It Works Text</label>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="saveAgent" >Update How It works</button>
                                </div>
                            </form>

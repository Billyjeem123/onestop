...
<head>
    <meta charset="UTF-8">
    <title>View All Units | Admin Portal </title>
                            ...
                            <div class="card" style="padding: 5px;">
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <?php
                                        $trans=mysqli_query($con,"SELECT * FROM units ORDER BY  uNo DESC ");
                                        $no = 0;
                                        while($row = mysqli_fetch_array($trans))
                                        {
                                            ...
                                            <tr style="font-size: 10px;">
                                                ...
                                                <td><?php echo $row['aOneName']; ?></td>
                                                <td><?php echo $row['aOnePhone']; ?></td>
                                                <td><?php echo $row['aTwoName']; ?></td>
                                                <td><?php echo $row['aTwoPhone']; ?></td>

...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>About Us | Onestop Procurement</title>
		...
		<div class="d-flex flex-column flex-root">
            ...
            <div class="mb-n10 mb-lg-n10 z-index-2">
                ...
                <div class="container">
                    ...
                    <div >
                        <!--begin::Title-->
                        <h3 class="fs-2hx mb-5" id="contact_us" style="color:#2B3187;">About Us</h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <div class="row w-100 mb-20 container" style="text-align:justify;font-size:15px;font-family:verdana;">
                        <p>
                        ...
                        <p>
                            As a result of these, businesses find it extremely difficult to execute standard due diligence
                            checks that help to limit exposure to supply-chain risks.
                        </p>
                        <p>
                            Experienced and respected professionals established Onestop Procurement to provide a wide 
                            array of value-added advisory services to its clients in risk management, strategic management, 
                            suppliers’ verification, ID verifications, and training.
                        </p>
                        <p>
                            OSP helps its customers win in their businesses by making risk management valuable. We listen,
                            innovate, and provide unique solutions that give our customers tools to expand and uncover new
                            opportunities. We build these solutions so our customers can focus on achieving their business
                            goals.
                        </p>
                        <p>
                            Enterprises rely on our solutions to tap into valuable, relevant, and up-to-date insights that drive
                            accelerated business growth.
                        </p>
                    </div>
                    <!--begin::Row-->
                    <div class="row w-100 gy-10 mb-md-20 container" style="background: #fff !important; box-shadow:  0 10px 5px 0 #cccccc; border:1px solid #2B3187;">
                        <!-- begin::col -->
                        <div class="col-md-6">
                            <h1 class="text-dark mb-10 text-left" id="contact_us">Our Vision</h1>
                        <p style="text-align:justify;font-size:17px; font-family:cursive;padding-right:15px;"> 
                            OSP wants to change the way companies, corporates, financial institutions, and governments
                            look at risk management, due diligence, and supply chain
                        </p>    
                        </div>
                        <!-- end::col -->
                        <!-- begin::col -->
                        <div class="col-md-6">
                            <h1 class="mb-10 text-left" id="contact_us" style="color:#2B3187;">Our Mission</h1>
                            <p style="text-align:justify;font-size:17px;font-weight:600px; font-family:cursive;">
                                Our mission is to create a comprehensive approach to anticipate, identify, prioritize, manage and
